...
router.post(
	...
	check('hospitalPhone', 'Enter a valid phone number!')
...
router.get(
	'/getAllNotifications',
	isHospital,
	hospitalController.getAllNotifications
);
router.get('/bloodRequests', isHospital, hospitalController.getBloodRequests);
